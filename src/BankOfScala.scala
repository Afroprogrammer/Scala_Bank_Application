...
object BankOfScala {
  ...
  */
  ...
  /* ------------------- Data ------------------- */
  private def getCustomers: Seq[(String, String, String, String)] = {
    Seq(
  ...
  private def getDepositProducts: Seq[(String, Int, Double)] = {
    Seq(
  ...
  private def getLendingProducts: Seq[(String, Double, Double, Double)] = {
